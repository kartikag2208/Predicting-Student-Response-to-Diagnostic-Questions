...
def load_train_csv():
    ...
    """
    path = os.path.join(os.getcwd(), "train_data.csv")
...
def load_valid_csv():
    ...
    :return: A dictionary {user_id: list, question_id: list, is_correct: list}
        ...
        (user_id, question_id) pair.
    """
    path = os.path.join(os.getcwd(), "valid_data.csv")
    return _load_csv(path)


def load_public_test_csv():
